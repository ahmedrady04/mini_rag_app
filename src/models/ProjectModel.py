...
class ProjectModel(BaseDataModel):
    ...
    def __init__(self,db_client:object):
        ...
        self.collection=self.db_client[DataBaseEnum.COLLECTION_PROJECT_NUME.value]
    ...
    async def init_collection(self):
        ...
        if DataBaseEnum.COLLECTION_PROJECT_NUME.value not in all_collections:
            self.collection=self.db_client[DataBaseEnum.COLLECTION_PROJECT_NUME.value]
    ...
    async def get_all_projects(self,page:int=1,page_size:int=1):
        ...
        ##claculate total_number of page 
